...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 6387726353935556081),
    name: 'Project',
    lastPropertyId: const obx_int.IdUid(2, 2245303355654418702),
    flags: 2,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 7611622195420422924),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 2245303355654418702),
        name: 'name',
        type: 9,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(2, 1399781035138101815),
    name: 'Task',
    lastPropertyId: const obx_int.IdUid(5, 1714917992057190006),
    flags: 2,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 6030859366543476845),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 5602716292730668292),
        name: 'title',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 7926520163404148941),
        name: 'description',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 4616075468322091873),
        name: 'isCompleted',
        type: 1,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 1714917992057190006),
        name: 'projectId',
        type: 11,
        flags: 520,
        indexId: const obx_int.IdUid(1, 3666021084703680257),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    entities: _entities,
    lastEntityId: const obx_int.IdUid(2, 1399781035138101815),
    lastIndexId: const obx_int.IdUid(1, 3666021084703680257),
